...
## Softshrink (0.5 points)

Development of forward and backward of Softshrink non-linearity. No for-loops or functions from the
nn package can be used.

## Embeddings (0.5 points)
